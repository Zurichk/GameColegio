...
fn translate(es: &str, lang: Language) -> Option<&'static str> {
    ...
    let (en, fr) = match es {
        ...
        "ANAGRAMAS" => ("ANAGRAMS", "ANAGRAMMES"),
        "Anagramas" => ("Anagrams", "Anagrammes"),
        "FRACCIONES" => ("FRACTIONS", "FRACTIONS"),
        "Fracciones" => ("Fractions", "Fractions"),
        "GEOMETRÍA" => ("GEOMETRY", "GÉOMÉTRIE"),
        "Geometría" => ("Geometry", "Géométrie"),
        "PROBLEMAS" => ("WORD PROBLEMS", "PROBLÈMES"),
        "Problemas" => ("Word problems", "Problèmes"),
        "ADIVINA EL NÚMERO" => ("GUESS THE NUMBER", "DEVINE LE NOMBRE"),
        "Adivina el Número" => ("Guess the Number", "Devine le nombre"),
        "Enviar" => ("Send", "Envoyer"),
        "Reiniciar" => ("Restart", "Recommencer"),
        "CUERPO HUMANO" => ("HUMAN BODY", "CORPS HUMAIN"),
        "Cuerpo humano" => ("Human body", "Corps humain"),
        "UNIVERSO" => ("SPACE", "UNIVERS"),
        "Universo" => ("Space", "Univers"),
        "SINÓNIMOS" => ("SYNONYMS", "SYNONYMES"),
        "Sinónimos" => ("Synonyms", "Synonymes"),
        "Sinónimo de \"{}\"" => ("Synonym of \"{}\"", "Synonyme de \"{}\""),
        "Palabra {}/{}  ·  Aciertos: {}  ·  Fallos: {}" => ("Word {}/{}  ·  Correct: {}  ·  Wrong: {}", "Mot {}/{}  ·  Réussites : {}  ·  Erreurs : {}"),
        "Aciertos: {} · Fallos: {}  de {} palabras" => ("Correct: {} · Wrong: {}  out of {} words", "Réussites : {} · Erreurs : {}  sur {} mots"),
        "Aciertos: {} · Fallos: {}  de {} problemas" => ("Correct: {} · Wrong: {}  out of {} problems", "Réussites : {} · Erreurs : {}  sur {} problèmes"),
        "Problema {}/{}  ·  Aciertos: {}  ·  Fallos: {}" => ("Problem {}/{}  ·  Correct: {}  ·  Wrong: {}", "Problème {}/{}  ·  Réussites : {}  ·  Erreurs : {}"),
        "Juegos Clásicos" => ("Classic Games", "Jeux classiques"),
        "JUEGOS CLÁSICOS" => ("CLASSIC GAMES", "JEUX CLASSIQUES"),
        "Reúnete y juega — 2 jugadores o contra la CPU" => ("Gather and play — 2 players or vs CPU", "Rassemblez-vous et jouez — 2 joueurs ou contre l'IA"),
        "Tres en Raya" => ("Tic Tac Toe", "Morpion"),
        "Conecta 4" => ("Connect 4", "Puissance 4"),
        "Hundir la Flota (5×5)" => ("Battleship (5×5)", "Bataille navale (5×5)"),
        "La Oca" => ("Game of the Goose", "Jeu de l'Oie"),
        "LA OCA" => ("GAME OF THE GOOSE", "JEU DE L'OIE"),
        "Parchís" => ("Parcheesi", "Parcheesi"),
        "PARCHÍS" => ("PARCHEESI", "PARCHEESI"),
        "Ruleta de la Fortuna" => ("Wheel of Fortune", "Roue de la Fortune"),
        "RULETA DE LA FORTUNA" => ("WHEEL OF FORTUNE", "ROUE DE LA FORTUNE"),
        "Cifras y Letras" => ("Numbers and Letters", "Chiffres et Lettres"),
        "CIFRAS Y LETRAS" => ("NUMBERS AND LETTERS", "CHIFFRES ET LETTRES"),
        "VOCABULARIO" => ("VOCABULARY", "VOCABULAIRE"),
        "Vocabulario" => ("Vocabulary", "Vocabulaire"),
        "Parejas de colores" => ("Color pairs", "Paires de couleurs"),
        "Parejas de banderas" => ("Flag pairs", "Paires de drapeaux"),
        "Volver" => ("Back", "Retour"),
