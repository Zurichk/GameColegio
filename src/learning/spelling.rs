...
/// Frases con errores ortográficos típicos del español — 60 frases.
const SPELLING_QUESTIONS: [SpellingQuestion; 60] = [
    ...
    SpellingQuestion { sentence: "El ______ canta muy bien.", options: ["jilguero", "gilguero", "jilgero", "gilgero"], correct: 0 },
    SpellingQuestion { sentence: "Necesito ______ para dibujar.", options: ["colores", "kolores", "colorres", "colorez"], correct: 0 },
    SpellingQuestion { sentence: "La ______ está en la mesa.", options: ["botella", "votella", "boteya", "voteya"], correct: 0 },
    SpellingQuestion { sentence: "El ______ brilla en el cielo.", options: ["relámpago", "relampago", "relanpago", "relanpago"], correct: 0 },
    SpellingQuestion { sentence: "Me gusta la ______ de vainilla.", options: ["gelatina", "jelatina", "gelatyna", "jelatyna"], correct: 0 },
    SpellingQuestion { sentence: "El ______ es muy inteligente.", options: ["hombre", "ombre", "honbre", "hombree"], correct: 0 },
    SpellingQuestion { sentence: "La ______ es muy bonita.", options: ["mariposa", "maripossa", "mariposa", "maripoza"], correct: 0 },
    SpellingQuestion { sentence: "Tengo que ______ la lección.", options: ["estudiar", "estudíar", "estudiar", "eztudiar"], correct: 0 },
    SpellingQuestion { sentence: "El ______ está en el zoológico.", options: ["tigre", "tigrre", "tijre", "tigree"], correct: 0 },
    SpellingQuestion { sentence: "Vamos a la ______ del cole.", options: ["excursión", "excursion", "escursion", "excurscion"], correct: 0 },
    SpellingQuestion { sentence: "Me duele el ______.", options: ["estómago", "estomago", "estómag", "estomago"], correct: 0 },
    SpellingQuestion { sentence: "El ______ es de color amarillo.", options: ["plátano", "platano", "plátanno", "platanó"], correct: 0 },
    SpellingQuestion { sentence: "La ______ es esdrújula.", options: ["brújula", "brujula", "brujula", "brujola"], correct: 0 },
    SpellingQuestion { sentence: "El ______ hace 'miau'.", options: ["gato", "gato", "gatho", "gatoph"], correct: 0 },
    SpellingQuestion { sentence: "Mi ______ es muy cariñosa.", options: ["abuela", "abuhela", "avuela", "abuela"], correct: 0 },
    SpellingQuestion { sentence: "El ______ del bosque es alto.", options: ["árbol", "arbol", "árvol", "árbols"], correct: 0 },
    SpellingQuestion { sentence: "Hay que ______ las manos.", options: ["lavar", "labar", "lavarr", "labarr"], correct: 0 },
    SpellingQuestion { sentence: "El ______ tiene ruedas.", options: ["coche", "coche", "kocho", "cooche"], correct: 0 },
    SpellingQuestion { sentence: "La ______ es muy útil.", options: ["bicicleta", "bicicleta", "bisicleta", "biscicleta"], correct: 0 },
    SpellingQuestion { sentence: "Voy a ______ una carta.", options: ["escribir", "escrivir", "escibrir", "esqribir"], correct: 0 },
    SpellingQuestion { sentence: "El ______ es muy grande.", options: ["océano", "oceano", "ozeano", "oceano"], correct: 0 },
    SpellingQuestion { sentence: "Necesito ______.", options: ["ayuda", "ayuda", "ayudda", "ajuda"], correct: 0 },
    SpellingQuestion { sentence: "El ______ es rojo.", options: ["tomate", "tomatte", "tomatte", "tommate"], correct: 0 },
    SpellingQuestion { sentence: "La ______ vuela alto.", options: ["gaviota", "gabiota", "gaviotta", "gaviota"], correct: 0 },
    SpellingQuestion { sentence: "Tengo un ______ nuevo.", options: ["juguete", "jugete", "juguetee", "juguete"], correct: 0 },
    SpellingQuestion { sentence: "El ______ está nublado.", options: ["cielo", "cielo", "sielo", "cielo"], correct: 0 },
    SpellingQuestion { sentence: "Vamos al ______.", options: ["parque", "parke", "parque", "parkue"], correct: 0 },
    SpellingQuestion { sentence: "El ______ es muy dulce.", options: ["azúcar", "azucar", "azukár", "azucar"], correct: 0 },
    SpellingQuestion { sentence: "La ______ tiene espinas.", options: ["rosa", "rosa", "rrosa", "roza"], correct: 0 },
    SpellingQuestion { sentence: "El ______ ladra fuerte.", options: ["perro", "perro", "perrro", "pero"], correct: 0 },
];

/// Frases de ortografía típicas del inglés — 60 frases.
const SPELLING_QUESTIONS_EN: [SpellingQuestion; 60] = [
    ...
    SpellingQuestion { sentence: "I ______ to the market.", options: ["went", "whent", "weent", "whent"], correct: 0 },
    SpellingQuestion { sentence: "She is very ______.", options: ["happy", "hapy", "happi", "happyy"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is yellow.", options: ["sun", "sunn", "son", "soon"], correct: 0 },
    SpellingQuestion { sentence: "I have two ______.", options: ["eyes", "eyese", "eies", "eyess"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is cold.", options: ["water", "watre", "watter", "weter"], correct: 0 },
    SpellingQuestion { sentence: "My ______ is big.", options: ["family", "familly", "famely", "famili"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is on the table.", options: ["book", "bok", "boook", "bokk"], correct: 0 },
    SpellingQuestion { sentence: "I like ______.", options: ["music", "musik", "musick", "mussic"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is fast.", options: ["car", "carr", "car", "caar"], correct: 0 },
    SpellingQuestion { sentence: "We have a small ______.", options: ["garden", "gardenn", "garden", "garden"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is white.", options: ["snow", "sno", "snnow", "snoww"], correct: 0 },
    SpellingQuestion { sentence: "She has long ______.", options: ["hair", "hare", "hiar", "hairr"], correct: 0 },
    SpellingQuestion { sentence: "I need some ______.", options: ["water", "watre", "watter", "weter"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is bright.", options: ["light", "lite", "lighte", "ligt"], correct: 0 },
    SpellingQuestion { sentence: "He is my best ______.", options: ["friend", "freind", "frend", "friend"], correct: 0 },
    SpellingQuestion { sentence: "We play in the ______.", options: ["park", "parc", "parkk", "parke"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is heavy.", options: ["stone", "ston", "stoone", "stone"], correct: 0 },
    SpellingQuestion { sentence: "I see a ______.", options: ["bird", "brid", "birtd", "bird"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is sweet.", options: ["honey", "hony", "honeyy", "honei"], correct: 0 },
    SpellingQuestion { sentence: "She wears a red ______.", options: ["dress", "dres", "dresse", "dress"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is on the wall.", options: ["clock", "clok", "clockk", "clokc"], correct: 0 },
    SpellingQuestion { sentence: "I have a little ______.", options: ["sister", "siter", "siste", "sistre"], correct: 0 },
    SpellingQuestion { sentence: "The ______ barks loudly.", options: ["dog", "dogg", "dgo", "dog"], correct: 0 },
    SpellingQuestion { sentence: "He has a new ______.", options: ["bicycle", "bicicle", "bycicle", "bicycle"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is very old.", options: ["castle", "castel", "casttle", "caslte"], correct: 0 },
    SpellingQuestion { sentence: "We need more ______.", options: ["time", "tiime", "timme", "tie"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is open.", options: ["door", "dor", "doorr", "doore"], correct: 0 },
    SpellingQuestion { sentence: "I like ______ ice cream.", options: ["chocolate", "chocolat", "chocolate", "choclate"], correct: 0 },
    SpellingQuestion { sentence: "The ______ is in the sky.", options: ["cloud", "claud", "colud", "cloud"], correct: 0 },
    SpellingQuestion { sentence: "She is ______ at maths.", options: ["good", "god", "godd", "goodd"], correct: 0 },
];

/// Frases de ortografía típicas del francés — 60 frases.
const SPELLING_QUESTIONS_FR: [SpellingQuestion; 60] = [
    ...
    SpellingQuestion { sentence: "Il fait très ______ aujourd'hui.", options: ["beau", "beu", "beauu", "beaux"], correct: 0 },
    SpellingQuestion { sentence: "J'ai un petit ______.", options: ["chat", "cha", "chta", "chatt"], correct: 0 },
    SpellingQuestion { sentence: "Elle porte une ______ rouge.", options: ["robe", "rob", "roobe", "robe"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est dans le ciel.", options: ["soleil", "solei", "soleill", "soleil"], correct: 0 },
    SpellingQuestion { sentence: "Nous avons une petite ______.", options: ["maison", "meson", "maisson", "maison"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est très grand.", options: ["arbre", "arbe", "arbree", "arbre"], correct: 0 },
    SpellingQuestion { sentence: "J'aime le ______.", options: ["chocolat", "chocola", "chocolatt", "chocolat"], correct: 0 },
    SpellingQuestion { sentence: "Elle a de longs ______.", options: ["cheveux", "cheveus", "cheveux", "cheveu"], correct: 0 },
    SpellingQuestion { sentence: "Il a un nouveau ______.", options: ["vélo", "velo", "vello", "vélo"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est lumineux.", options: ["soleil", "solei", "soleill", "soleil"], correct: 0 },
    SpellingQuestion { sentence: "Nous jouons dans le ______.", options: ["jardin", "jardin", "jarrdin", "jardin"], correct: 0 },
    SpellingQuestion { sentence: "La ______ est blanche.", options: ["neige", "nege", "neigge", "neige"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est rapide.", options: ["train", "trin", "traine", "train"], correct: 0 },
    SpellingQuestion { sentence: "Elle est très ______.", options: ["heureuse", "heurese", "heureuse", "heureusse"], correct: 0 },
    SpellingQuestion { sentence: "Il a deux ______.", options: ["yeux", "ieux", "yeus", "yeux"], correct: 0 },
    SpellingQuestion { sentence: "La ______ est sur la table.", options: ["fleur", "fleure", "fleur", "fluer"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est lourd.", options: ["sac", "sack", "sac", "sacc"], correct: 0 },
    SpellingQuestion { sentence: "Je vois un ______.", options: ["oiseau", "oisseau", "oiseu", "oiseau"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ miaule.", options: ["chat", "cha", "chta", "chat"], correct: 0 },
    SpellingQuestion { sentence: "Elle a un ______ neuf.", options: ["cartable", "cartabl", "cartable", "cartable"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est très vieux.", options: ["château", "chateau", "châtaeu", "château"], correct: 0 },
    SpellingQuestion { sentence: "Nous avons besoin de ______.", options: ["temps", "temp", "temps", "tamps"], correct: 0 },
    SpellingQuestion { sentence: "La ______ est ouverte.", options: ["porte", "port", "portte", "porte"], correct: 0 },
    SpellingQuestion { sentence: "J'aime la ______ au chocolat.", options: ["glace", "glas", "glasse", "glace"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est dans le ciel.", options: ["nuage", "nuage", "nuaje", "nuage"], correct: 0 },
    SpellingQuestion { sentence: "Elle est ______ en maths.", options: ["forte", "fort", "fortte", "forte"], correct: 0 },
    SpellingQuestion { sentence: "Il a un ______ rouge.", options: ["ballon", "balon", "balllon", "ballon"], correct: 0 },
    SpellingQuestion { sentence: "La ______ est verte.", options: ["pomme", "pome", "pomme", "pom"], correct: 0 },
    SpellingQuestion { sentence: "Le ______ est sucré.", options: ["miel", "miel", "mielle", "miel"], correct: 0 },
    SpellingQuestion { sentence: "Nous allons au ______.", options: ["parc", "parque", "parc", "parc"], correct: 0 },
];